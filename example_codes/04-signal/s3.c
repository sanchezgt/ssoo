/* 
Este programa en C demuestra el uso de señales entre procesos y el manejo de procesos hijos.
...
3. Compila el programa con el siguiente comando:
   gcc -o signal_process signal_process.c
...
int main() {
    ...
    switch (pidhijo) {
        ...
        default: // Proceso padre
            ...
            usleep(100); // Pequeña pausa para asegurar que el hijo esté listo
